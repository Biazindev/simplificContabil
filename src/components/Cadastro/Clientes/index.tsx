...
const CadastroCliente = () => {
            ...
            if (response) {
                ...
                if (response.pessoaFisica) {
                    ...
                    setForm({
                        ...
                        endereco: {
                            logradouro: response.pessoaFisica.endereco?.logradouro ?? '',
                            numero: response.pessoaFisica.endereco?.numero ?? '',
                            bairro: response.pessoaFisica.endereco?.bairro ?? '',
                            municipio: response.pessoaFisica.endereco?.municipio ?? '',
                            uf: response.pessoaFisica.endereco?.uf ?? '',
                            cep: response.pessoaFisica.endereco?.cep ?? '',
                            complemento: response.pessoaFisica.endereco?.complemento ?? '',
                        }
                    });
                    ...
                    setForm({
                        ...
                        endereco: {
                            logradouro: response.pessoaJuridica.endereco?.logradouro ?? '',
                            numero: response.pessoaJuridica.endereco?.numero ?? '',
                            bairro: response.pessoaJuridica.endereco?.bairro ?? '',
                            municipio: response.pessoaJuridica.endereco?.municipio ?? '',
                            uf: response.pessoaJuridica.endereco?.uf ?? '',
                            cep: response.pessoaJuridica.endereco?.cep ?? '',
                            complemento: response.pessoaJuridica.endereco?.complemento ?? '',
                        }
                    });
                }
            }
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (clienteExistente) {
                let payload: UpdateClienteRequest;
                ...
                let payload: CreateClienteRequest;
